...
private:
    ...
    string _PrepareTransferLogRecord(clsBankClient DistenationClient, float Amount, string Seperator = "#//#")
    {
        string TransferLogRecord = "";

        TransferLogRecord += clsDate::GetSystemDateTimeString() + Seperator;
        TransferLogRecord += AccountNumber() + Seperator;
        TransferLogRecord += DistenationClient.AccountNumber() + Seperator;
        TransferLogRecord += to_string(Amount) + Seperator;
        TransferLogRecord += to_string(AccountBalance) + Seperator;
        TransferLogRecord += to_string(DistenationClient.AccountBalance) + Seperator;
        TransferLogRecord += CurrentUser.UserName;

        return TransferLogRecord;
    }

    void _RegisterTransferLog(clsBankClient DistenationClient, int Amount)
    {
        string DataLine = _PrepareTransferLogRecord(DistenationClient, Amount);
    ...
    static stTransferLogRecord _ConvertTransferLogLineToRecord(string Line, string Seperator = "#//#")
    {
        ...
        stTransferLogRecord TransferData;
        ...
        TransferData.Amount += stod(vTransferData[3]);
        TransferData.SourceAccountNumber += stod(vTransferData[4]);
        TransferData.DestinationAccountNumber += stod(vTransferData[5]);
